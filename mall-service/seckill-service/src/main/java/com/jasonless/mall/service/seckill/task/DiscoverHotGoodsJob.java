package com.jasonless.mall.service.seckill.task;

import com.dangdang.ddframe.job.api.ShardingContext;
import com.dangdang.ddframe.job.api.simple.SimpleJob;
import com.dangdang.elasticjob.lite.annotation.ElasticSimpleJob;
import com.jasonless.mall.api.dw.feign.HotGoodsFeign;
...
@Component
public class DiscoverHotGoodsJob implements SimpleJob {
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        ResponseResult<List<Map<String, String>>> listRespResult = hotGoodsFeign.searchHot(size, hour, max, ids);
        //集合数据获取
